...
export default function Page() {
  return (
    <section className="relative min-h-[150vh] flex pt-36 justify-center px-10 -z-9">
      <ContactHeroBackground />
      <div className="items-center">
        <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-8 text-white">
          <div className="order-3 lg:order-1 space-y-6 md:pr-6">
            <div className="mb-14">
            ...
            <iframe
              ...
              className="w-[100vw] -ml-10 lg:w-3/4 lg:ml-0 lg:rounded-xl h-[60vh] border-0"
              loading="lazy"
            />
          </div>
          ...
          <div className="order-1 lg:order-3 ml-0 lg:ml-12 space-y-4">
            <div className="mb-14">
              <h2 className={cn('text-3xl font-bold', playfair.className)}>
                Let’s get in touch
              </h2>
